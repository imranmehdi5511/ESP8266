# ESP8266 I2T Receiver --  HTTP Protocol
...
# Debugging
## Open Serial Monitor
If configured correctly, *ESP8266* should be getting data from ***Keepy*** automatically. However, you may want to verify that it is running on *ESP8266*.
...
![ESP8266 receiver Serial Monitor](https://i.postimg.cc/m2zhLhPr/Screenshot-from-2020-11-12-12-20-21.png)

## Send Harcoded Json to Keepy to see ESP8266 reactions
