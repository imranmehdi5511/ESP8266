...
- **[MQTT-sender](https://github.com/iot2tangle/ESP8266/tree/main/mqtt-sender)** -- ESP8266 will send the sensors data through MQTT to **[I2T MQTT Gateway](https://github.com/iot2tangle/Streams-mqtt-gateway)**
